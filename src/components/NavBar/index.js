  ...
  return (
    <nav className='w-full border-b sticky bg-white z-50 top-0'>
      <div className='py-5 md:py-0 container mx-auto px-6 flex items-center justify-between'>
        ...
        <button className='focus:outline-none lg:text-lg lg:font-bold focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 hidden md:block bg-transparent transition duration-150 ease-in-out hover:bg-indigo-700 rounded border border-indigo-700 text-indigo-700 hover:text-white px-4 sm:px-8 py-1 sm:py-3 text-sm'>
